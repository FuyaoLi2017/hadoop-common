...
public class DFForUsage extends DU {
  ...
  public DFForUsage(File path, long interval, long initialUsed) throws IOException {
   ...
   * @throws IOException if we fail to refresh the disk usage
   */
  public DFForUsage(File path, Configuration conf) throws IOException {
    super(path, conf);
    //this(path, 600000L);
    //10 minutes default refresh interval
  }

  public DFForUsage(File path, Configuration conf, long initialUsed)
      throws IOException {
